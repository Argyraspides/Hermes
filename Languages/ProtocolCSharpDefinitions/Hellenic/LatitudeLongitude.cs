...
partial class LatitudeLongitude : HellenicMessage
{
	...
	/// <summary>
	/// Reference frame (0 = Mercury, 1 = Venus, 2 = Earth, 3 = Moon, 4 =
	/// Mars ...)
	/// </summary>
	...
	{
		Id = 0;
		MessageName = nameof(LatitudeLongitude);
	}

	public LatitudeLongitude(double pLat, double pLon, byte pReferenceFrame, ulong pTimeUsec, uint pMachineId, uint pOriginalProtocol)
	{
		Id = 0;
		MessageName = nameof(LatitudeLongitude);
		Lat = pLat;
